...
select dictGet('my_schema.ch_price_dict', 'price', tuple(333636, 'R001', 2));
select dictGet('my_schema.ch_chanel_dict', 'txtsh', 2);
select dictGet('my_schema.ch_product_dict', 'txt', 333636);
select dictGet('my_schema.ch_region_dict', 'txt', 'R004');
