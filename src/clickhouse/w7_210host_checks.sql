...
select dictGet('my_schema.ch_price_dict', 'price', tuple(450444, 'R001', 1));
select dictGet('my_schema.ch_chanel_dict', 'txtsh', 1);
select dictGet('my_schema.ch_product_dict', 'txt', 467658);
select dictGet('my_schema.ch_region_dict', 'txt', 'R003');
